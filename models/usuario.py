...
class Usuario:
    ...
    def __init__(self, nombre: str, correo: str, dni: str, id_usuario: int = None, fecha_registro: datetime = None):
        self.id = id_usuario
        self.nombre = nombre
        self.correo = correo
        self.dni = dni
    ...
    def __str__(self):
        ...
        return f"Usuario [ID: {id_str}] DNI: {self.dni} | {self.nombre} - Correo: {self.correo} (Registrado: {fecha_str})"
